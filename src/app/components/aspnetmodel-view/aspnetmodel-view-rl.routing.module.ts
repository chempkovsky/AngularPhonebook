...
//        outlet: 'loltnmaspnetmodelView',
        ...
        data: { isdtl: true, vn: 'aspnetusermaskView', va: 'l', ms: true,  /* oltn: 'loltnmaspnetmodelView', */ np: '', fh: 2, mh: 10, sf: true,  title: rllzaspnetmodelView['ListaspnetusermaskView'],  hf: 'hf102',  dp: 2, uid: 'bfea3509d5184a3c81e6911f418e08c3' },
        canActivate: [AppGlblSettingsServiceActivator],
    },
...
//        outlet: 'loltnmaspnetmodelView',
        ...
        data: { isdtl: true, vn: 'aspnetrolemaskView', va: 'l', ms: true,  /* oltn: 'loltnmaspnetmodelView', */ np: '', fh: 2, mh: 10, sf: true,  title: rllzaspnetmodelView['ListaspnetrolemaskView'],  hf: 'hf102',  dp: 2, uid: '8569794d6ca148c1a283beb8120a964b' },
        canActivate: [AppGlblSettingsServiceActivator],
    },
