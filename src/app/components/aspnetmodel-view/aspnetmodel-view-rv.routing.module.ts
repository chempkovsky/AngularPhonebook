...
//
    { 
        ...
        data: {  isdtl: true, vn: 'aspnetusermaskView', va: 'l', ms: true,  /* oltn: 'oltnmaspnetmodelView', */ np: '', fh: 2, mh: 10, sf: true, title: rvllzaspnetmodelView['ListaspnetusermaskView'], hf: 'hf102',  dp: 2, uid: '172df28a0d7d401191b6dbe2c7f47bb9' },
        canActivate: [AppGlblSettingsServiceActivator],
    },
...
//
    ...
    { 
        ...
        data: {  isdtl: true, vn: 'aspnetrolemaskView', va: 'l', ms: true,  /* oltn: 'oltnmaspnetmodelView', */ np: '', fh: 2, mh: 10, sf: true, title: rvllzaspnetmodelView['ListaspnetrolemaskView'], hf: 'hf102',  dp: 2, uid: '26f8e125459f422bb675499f64459ca9' },
        canActivate: [AppGlblSettingsServiceActivator],
    },
