...
import { IUniqServiceFilterDef } from './../../../shared/interfaces/uniq-service-filter-def.interface';
import { IUniqServiceFilter } from './../../../shared/interfaces/uniq-service-filter.interface';
...
import { LpdEmpLastNameViewService } from './../../../services/lpd-emp-last-name-view/lpd-emp-last-name-view.service';
import { ILpdEmpLastNameView } from './../../lpd-emp-last-name-view/interfaces/lpd-emp-last-name-view.interface';
import { ILpdEmpLastNameViewPage } from './../../lpd-emp-last-name-view/interfaces/lpd-emp-last-name-view-page.interface';
import { ILpdEmpLastNameViewFilter } from './../../lpd-emp-last-name-view/interfaces/lpd-emp-last-name-view-filter.interface';
import { LpdEmpFirstNameViewService } from './../../../services/lpd-emp-first-name-view/lpd-emp-first-name-view.service';
import { ILpdEmpFirstNameView } from './../../lpd-emp-first-name-view/interfaces/lpd-emp-first-name-view.interface';
import { ILpdEmpFirstNameViewPage } from './../../lpd-emp-first-name-view/interfaces/lpd-emp-first-name-view-page.interface';
import { ILpdEmpFirstNameViewFilter } from './../../lpd-emp-first-name-view/interfaces/lpd-emp-first-name-view-filter.interface';
import { LpdEmpSecondNameViewService } from './../../../services/lpd-emp-second-name-view/lpd-emp-second-name-view.service';
import { ILpdEmpSecondNameView } from './../../lpd-emp-second-name-view/interfaces/lpd-emp-second-name-view.interface';
import { ILpdEmpSecondNameViewPage } from './../../lpd-emp-second-name-view/interfaces/lpd-emp-second-name-view-page.interface';
import { ILpdEmpSecondNameViewFilter } from './../../lpd-emp-second-name-view/interfaces/lpd-emp-second-name-view-filter.interface';
import { LprEmployee01ViewService } from './../../../services/lpr-employee01-view/lpr-employee01-view.service';
import { ILprEmployee01View } from './../../lpr-employee01-view/interfaces/lpr-employee01-view.interface';
import { ILprEmployee01ViewPage } from './../../lpr-employee01-view/interfaces/lpr-employee01-view-page.interface';
import { ILprEmployee01ViewFilter } from './../../lpr-employee01-view/interfaces/lpr-employee01-view-filter.interface';
import { LprEmployee02ViewService } from './../../../services/lpr-employee02-view/lpr-employee02-view.service';
import { ILprEmployee02View } from './../../lpr-employee02-view/interfaces/lpr-employee02-view.interface';
import { ILprEmployee02ViewPage } from './../../lpr-employee02-view/interfaces/lpr-employee02-view-page.interface';
import { ILprEmployee02ViewFilter } from './../../lpr-employee02-view/interfaces/lpr-employee02-view-filter.interface';
...
//===============
    ...
    resetexternalFilter() {
        ...
        if(ef.pgsz) { this.currentPageSize = ef.pgsz; } else { this.currentPageIndex = 10; }
