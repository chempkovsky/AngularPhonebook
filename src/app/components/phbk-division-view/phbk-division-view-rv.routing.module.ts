...
//
    { 
        ...
        loadChildren: () => import('./../phbk-employee-view/phbk-employee-view-rv-lazy.routing.module').then(m => m.PhbkEmployeeViewRvLazyRoutingModule),
    ...
    { 
        ...
        loadChildren: () => import('./../phbk-employee-view/phbk-employee-view-ra-lazy.routing.module').then(m => m.PhbkEmployeeViewRaLazyRoutingModule),
    ...
    { 
        ...
        loadChildren: () => import('./../phbk-employee-view/phbk-employee-view-ru-lazy.routing.module').then(m => m.PhbkEmployeeViewRuLazyRoutingModule),
    ...
    { 
        ...
        loadChildren: () => import('./../phbk-employee-view/phbk-employee-view-rd-lazy.routing.module').then(m => m.PhbkEmployeeViewRdLazyRoutingModule),
    ...
    { 
        ...
        data: {  isdtl: true, vn: 'PhbkEmployeeView', va: 'l', ms: true,  /* oltn: 'oltnmPhbkDivisionView', */ np: '', fh: 2, mh: 10, sf: true, title: rvllzPhbkDivisionView['ListPhbkEmployeeView'], hf: 'hf102',  dp: 2, uid: '2856cd7ebe194da195aed98fbef76716' },
        canActivate: [AppGlblSettingsServiceActivator],
    },
