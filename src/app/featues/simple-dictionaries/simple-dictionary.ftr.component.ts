...
@Component({
  selector: 'app-simple-dictionary-ftr',
  templateUrl: './simple-dictionary.ftr.component.html',
  styleUrls: ['./simple-dictionary.ftr.component.css']
})
export class SimpleDictionaryFtrComponent  {
    curBreakpoint: number = 1;
    isExp: boolean[] = [false, false, false, false];
    colSpan: number[][]= [
            [1, 1, 2, 1, 1, 2],
            [1, 1, 2, 1, 1, 2],
            [1, 1, 2, 1, 1, 2],
