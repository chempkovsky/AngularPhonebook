...
import { ILpdEmpFirstNameView } from './../../components/lpd-emp-first-name-view/interfaces/lpd-emp-first-name-view.interface';
import { ILpdEmpFirstNameViewPage } from './../../components/lpd-emp-first-name-view/interfaces/lpd-emp-first-name-view-page.interface';
import { ILpdEmpFirstNameViewFilter } from './../../components/lpd-emp-first-name-view/interfaces/lpd-emp-first-name-view-filter.interface';
...
export class LpdEmpFirstNameViewDatasource implements IViewModelDatasource {
    ...
    protected _Values: {[key: string]: any} = {
      'empFirstNameId': undefined,  // number, System.Int32
