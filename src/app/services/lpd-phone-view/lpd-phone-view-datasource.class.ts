...
import { ILpdPhoneView } from './../../components/lpd-phone-view/interfaces/lpd-phone-view.interface';
import { ILpdPhoneViewPage } from './../../components/lpd-phone-view/interfaces/lpd-phone-view-page.interface';
import { ILpdPhoneViewFilter } from './../../components/lpd-phone-view/interfaces/lpd-phone-view-filter.interface';
...
export class LpdPhoneViewDatasource implements IViewModelDatasource {
    ...
    protected _Values: {[key: string]: any} = {
      'lpdPhoneId': undefined,  // number, System.Int32
