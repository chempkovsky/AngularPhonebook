...
import { ILprDivision01View } from './../../components/lpr-division01-view/interfaces/lpr-division01-view.interface';
import { ILprDivision01ViewPage } from './../../components/lpr-division01-view/interfaces/lpr-division01-view-page.interface';
import { ILprDivision01ViewFilter } from './../../components/lpr-division01-view/interfaces/lpr-division01-view-filter.interface';
...
export class LprDivision01ViewService {
    ...
    // });
    // 
    deleteone(divisionNameIdRef: number , divisionId: number ): Observable<ILprDivision01View> {
        let params: HttpParams  = new HttpParams({encoder: this.appGlblSettings});
        let hasFilter: boolean = false;
        if (!(typeof divisionId === 'undefined')) {
            if (!(divisionId === null)) {
