...
exports.LprDivision02ViewDatasource = void 0;
var core_1 = require("@angular/core");
var rxjs_1 = require("rxjs");
var of_1 = require("rxjs/internal/observable/of");
var LprDivision02ViewDatasource = /** @class */ (function () {
    function LprDivision02ViewDatasource(frmRootSrv, appGlblSettings, ClientViewName, DirectNavigation, CurrentlyDirectMasterNavs, UIFormChain) {
        this.frmRootSrv = frmRootSrv;
        this.appGlblSettings = appGlblSettings;
        this._CurrentViewName = 'LprDivision02View';
    ...
    LprDivision02ViewDatasource.prototype.doEmitEvent = function (aftrMstrChngd) {
    ...
    LprDivision02ViewDatasource.prototype.getHiddenFilterByRow = function (rw, nvNm) {
        return this.frmRootSrv.getHiddenFilterByRow(rw, nvNm);
    };
    LprDivision02ViewDatasource.prototype.getHiddenFilterByFltRslt = function (fr) {
        return this.frmRootSrv.getHiddenFilterByFltRslt(fr);
    };
    LprDivision02ViewDatasource.prototype.refreshIsDefined = function () {
        this._IsDefined = this.calcIsDefined();
        return this._IsDefined;
    };
    LprDivision02ViewDatasource.prototype.calcIsDefined = function () {
    ...
    LprDivision02ViewDatasource.prototype.getUIFormChain = function () {
        return this._UIFormChain;
    };
    LprDivision02ViewDatasource.prototype.getHiddenFilter = function () {
        return this._HiddenFilter;
    };
    LprDivision02ViewDatasource.prototype.getHiddenFilterAsFltRslt = function () {
        return this.frmRootSrv.getHiddenFilterAsFltRslt(this._HiddenFilter);
    };
    LprDivision02ViewDatasource.prototype.setHiddenFilter = function (fltr) {
        this._HiddenFilter = fltr;
        this.setUnderHiddenFilterFields();
    };
    LprDivision02ViewDatasource.prototype.getIsTopDetail = function () {
        return this._UIFormChain === '';
    };
    LprDivision02ViewDatasource.prototype.getIsDefined = function () {
        return this._IsDefined;
    };
    LprDivision02ViewDatasource.prototype.getCurrentViewName = function () {
        return this._CurrentViewName;
    };
    LprDivision02ViewDatasource.prototype.getClientViewName = function () {
        return this._ClientViewName;
    };
    LprDivision02ViewDatasource.prototype.getDirectNavigation = function () {
        return this._DirectNavigation;
    };
    LprDivision02ViewDatasource.prototype.getLength = function () {
        return this.frmRootSrv.getLength();
    };
    LprDivision02ViewDatasource.prototype.getKeys = function () {
        return this.frmRootSrv.getKeys();
    };
    LprDivision02ViewDatasource.prototype.getDtTpValue = function (key) {
        return this.frmRootSrv.getDtTpValue(key);
    };
    LprDivision02ViewDatasource.prototype.getValue = function (key) {
        return this._Values[key];
    };
    LprDivision02ViewDatasource.prototype.setValue = function (key, value) {
    ...
    LprDivision02ViewDatasource.prototype.getByOrgValue = function (org, fkchain) {
        var i = this.frmRootSrv.getKeyByOrgValue(org, fkchain);
        if (typeof i === 'undefined')
            return undefined;
        return this._Values[i];
    };
    LprDivision02ViewDatasource.prototype.setByOrgValue = function (org, fkchain, value) {
        var i = this.frmRootSrv.getKeyByOrgValue(org, fkchain);
        if (!(typeof i === 'undefined'))
            this._Values[i] = value;
    };
    LprDivision02ViewDatasource.prototype.requiredValue = function (key) {
        return this.frmRootSrv.requiredValue(key);
    };
    LprDivision02ViewDatasource.prototype.dbgeneratedValue = function (key) {
        return this.frmRootSrv.requiredValue(key);
    };
    LprDivision02ViewDatasource.prototype.isInPrimkeyValue = function (key) {
        return this.frmRootSrv.isInPrimkeyValue(key);
    };
    LprDivision02ViewDatasource.prototype.isSetValue = function (key) {
    ...
    LprDivision02ViewDatasource.prototype.clearValue = function (key) {
        if (this.frmRootSrv.getDtTpValue(key) === 'boolean') {
            this._Values[key] = false;
        }
        else {
    ...
    LprDivision02ViewDatasource.prototype.clear = function (doNotify) {
    ...
    LprDivision02ViewDatasource.prototype.isEqual = function (src, dest) {
    ...
    LprDivision02ViewDatasource.prototype.interface2Values = function (data, doNotify) {
        if (doNotify === void 0) { doNotify = true; }
    ...
    LprDivision02ViewDatasource.prototype.values2Interface = function () {
        return {
    ...
    LprDivision02ViewDatasource.prototype.submitOnDetailChanged = function (v) {
    ...
    LprDivision02ViewDatasource.prototype.clearPartially = function (doNotify) {
        var hasChanged = false;
    ...
    LprDivision02ViewDatasource.prototype.submitOnMasterChanged = function (v) {
    ...
    LprDivision02ViewDatasource.prototype.isSetFilterByCurrDirMstrs = function () {
        var m2cKeyfm = this.frmRootSrv.getm2cKeyfm();
    ...
    LprDivision02ViewDatasource.prototype.getWSFltrRsltByCurrDirMstrs = function () {
        var rslt = [];
        var m2cKeyfm = this.frmRootSrv.getm2cKeyfm();
        for (var i in m2cKeyfm) {
            for (var j in m2cKeyfm[i]) {
    ...
    LprDivision02ViewDatasource.prototype.getFilterByCurrDirMstrs = function () {
        var flt = {}; // ILprDivision02ViewFilter
        var m2cKeyfm = this.frmRootSrv.getm2cKeyfm();
        for (var i in m2cKeyfm) {
            for (var j in m2cKeyfm[i]) {
                if (this._CurrentlyDirectMasterNavs.indexOf(j) > -1) {
    ...
    LprDivision02ViewDatasource.prototype.handleError = function (result) {
        var _this = this;
    ...
    LprDivision02ViewDatasource.prototype.getCllctionByCurrDirMstrs = function () {
    ...
    LprDivision02ViewDatasource.prototype.getCllctionByFldFilter = function (fldName, fldVal) {
    ...
    LprDivision02ViewDatasource.prototype.getone = function (entrprsIdRef, divisionNameIdRef, divisionId) {
        var _this = this;
        this.frmRootSrv.getone(entrprsIdRef, divisionNameIdRef, divisionId).subscribe({
            next: function (data) {
    ...
    LprDivision02ViewDatasource.prototype.refresh = function () {
        if (this.isSetValue('entrprsIdRef')
            && this.isSetValue('divisionNameIdRef')
            && this.isSetValue('divisionId')) {
            this.getone(this.getValue('entrprsIdRef'), this.getValue('divisionNameIdRef'), this.getValue('divisionId'));
            return;
        }
        this.appGlblSettings.showError('http', { message: $localize(templateObject_1 || (templateObject_1 = __makeTemplateObject([":Not all Unique or Primary key properties are defined to call Refresh-method@@LprDivision02ViewDatasourcerefresh.Not-all-Unique-Primary:Not all Unique or Primary key properties are defined to call Refresh-method"], [":Not all Unique or Primary key properties are defined to call Refresh-method@@LprDivision02ViewDatasourcerefresh.Not-all-Unique-Primary:Not all Unique or Primary key properties are defined to call Refresh-method"]))) });
    };
    LprDivision02ViewDatasource.prototype.updateone = function () {
        var _this = this;
        if (!this.getIsDefined()) {
            this.appGlblSettings.showError('http', { message: $localize(templateObject_2 || (templateObject_2 = __makeTemplateObject([":Not all propertes are correctly defined@@LprDivision02ViewDatasourceupdateone.Not-all-propertes:Not all propertes are correctly defined"], [":Not all propertes are correctly defined@@LprDivision02ViewDatasourceupdateone.Not-all-propertes:Not all propertes are correctly defined"]))) });
            return;
        }
    ...
    LprDivision02ViewDatasource.prototype.addone = function () {
        var _this = this;
        if (!this.getIsDefined()) {
            this.appGlblSettings.showError('http', { message: $localize(templateObject_3 || (templateObject_3 = __makeTemplateObject([":Not all propertes are correctly defined@@LprDivision02ViewDatasourceaddone.Not-all-propertes:Not all propertes are correctly defined"], [":Not all propertes are correctly defined@@LprDivision02ViewDatasourceaddone.Not-all-propertes:Not all propertes are correctly defined"]))) });
            return;
        }
        var itm = this.values2Interface();
    ...
    LprDivision02ViewDatasource.prototype.deleteone = function () {
        var _this = this;
        if (!this.getIsDefined()) {
            this.appGlblSettings.showError('http', { message: $localize(templateObject_4 || (templateObject_4 = __makeTemplateObject([":Not all propertes are correctly defined@@LprDivision02ViewDatasourcedeleteone.Not-all-propertes:Not all propertes are correctly defined"], [":Not all propertes are correctly defined@@LprDivision02ViewDatasourcedeleteone.Not-all-propertes:Not all propertes are correctly defined"]))) });
            return;
        }
    ...
    LprDivision02ViewDatasource.prototype.setUnderHiddenFilterFields = function () {
        this._UnderHiddenFilterFields = [];
        var m2cKeyfm = this.frmRootSrv.getm2cKeyfm();
        var m2cfm = this.frmRootSrv.getm2cfm();
    ...
    LprDivision02ViewDatasource.prototype.isUnderHiddenFilterFields = function (fld) {
    ...
    LprDivision02ViewDatasource.prototype.updateByHiddenFilterFields = function (doNotify) {
        if (doNotify === void 0) { doNotify = true; }
        var hasChanged = false;
        var aftrMstrChngd = false;
        if (typeof this._HiddenFilter === 'undefined')
    ...
    LprDivision02ViewDatasource.prototype.getIsNew = function () {
        return this._IsNew;
    };
    LprDivision02ViewDatasource.prototype.setIsNew = function (v) {
        this._IsNew = v;
    };
    LprDivision02ViewDatasource.prototype.isReadonlyValue = function (key) {
    ...
    return LprDivision02ViewDatasource;
}());
exports.LprDivision02ViewDatasource = LprDivision02ViewDatasource;
var templateObject_1, templateObject_2, templateObject_3, templateObject_4;
//# sourceMappingURL=lpr-division02-view-datasource.class.js.map