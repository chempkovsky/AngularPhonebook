...
import { ILprDivision02View } from './../../components/lpr-division02-view/interfaces/lpr-division02-view.interface';
import { ILprDivision02ViewPage } from './../../components/lpr-division02-view/interfaces/lpr-division02-view-page.interface';
import { ILprDivision02ViewFilter } from './../../components/lpr-division02-view/interfaces/lpr-division02-view-filter.interface';
...
export class LprDivision02ViewService {
    ...
    // });
    // 
    deleteone(entrprsIdRef: number , divisionNameIdRef: number , divisionId: number ): Observable<ILprDivision02View> {
        let params: HttpParams  = new HttpParams({encoder: this.appGlblSettings});
        let hasFilter: boolean = false;
        if (!(typeof divisionId === 'undefined')) {
            if (!(divisionId === null)) {
