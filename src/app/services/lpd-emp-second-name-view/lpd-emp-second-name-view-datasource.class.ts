...
import { ILpdEmpSecondNameView } from './../../components/lpd-emp-second-name-view/interfaces/lpd-emp-second-name-view.interface';
import { ILpdEmpSecondNameViewPage } from './../../components/lpd-emp-second-name-view/interfaces/lpd-emp-second-name-view-page.interface';
import { ILpdEmpSecondNameViewFilter } from './../../components/lpd-emp-second-name-view/interfaces/lpd-emp-second-name-view-filter.interface';
...
export class LpdEmpSecondNameViewDatasource implements IViewModelDatasource {
    ...
    protected _Values: {[key: string]: any} = {
      'empSecondNameId': undefined,  // number, System.Int32
