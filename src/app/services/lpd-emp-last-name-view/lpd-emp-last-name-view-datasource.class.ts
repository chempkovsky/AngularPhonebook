...
import { ILpdEmpLastNameView } from './../../components/lpd-emp-last-name-view/interfaces/lpd-emp-last-name-view.interface';
import { ILpdEmpLastNameViewPage } from './../../components/lpd-emp-last-name-view/interfaces/lpd-emp-last-name-view-page.interface';
import { ILpdEmpLastNameViewFilter } from './../../components/lpd-emp-last-name-view/interfaces/lpd-emp-last-name-view-filter.interface';
...
export class LpdEmpLastNameViewDatasource implements IViewModelDatasource {
    ...
    protected _Values: {[key: string]: any} = {
      'empLastNameId': undefined,  // number, System.Int32
