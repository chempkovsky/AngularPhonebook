...
import { ILpdDivisionView } from './../../components/lpd-division-view/interfaces/lpd-division-view.interface';
import { ILpdDivisionViewPage } from './../../components/lpd-division-view/interfaces/lpd-division-view-page.interface';
import { ILpdDivisionViewFilter } from './../../components/lpd-division-view/interfaces/lpd-division-view-filter.interface';
...
export class LpdDivisionViewService {
    ...
    // });
    // 
    deleteone(divisionNameId: number ): Observable<ILpdDivisionView> {
        let params: HttpParams  = new HttpParams({encoder: this.appGlblSettings});
        let hasFilter: boolean = false;
        if (!(typeof divisionNameId === 'undefined')) {
            if (!(divisionNameId === null)) {
